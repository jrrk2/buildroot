...
#define HAVE_cmpdf (TARGET_FPU && TARGET_HARD_FLOAT_D)
...
#define HAVE_extendsfdf2 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_extendsfdf2 ();
#define HAVE_truncdfsf2 (TARGET_FPU && TARGET_HARD_FLOAT_D)
...
#define HAVE_adddf3 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_adddf3 ();
#define HAVE_subdf3 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_subdf3 ();
#define HAVE_muldf3 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_muldf3 ();
#define HAVE_divdf3 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_divdf3 ();
#define HAVE_negdf2 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_negdf2 ();
#define HAVE_absdf2 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_absdf2 ();
#define HAVE_floatsisf2 (TARGET_FPU)
extern rtx gen_floatsisf2 ();
#define HAVE_floatsidf2 (TARGET_FPU && TARGET_HARD_FLOAT_D)
extern rtx gen_floatsidf2 ();
#define HAVE_fix_truncsfsi2 (TARGET_FPU)
extern rtx gen_fix_truncsfsi2 ();
#define HAVE_fix_truncdfsi2 (TARGET_FPU && TARGET_HARD_FLOAT_D)
